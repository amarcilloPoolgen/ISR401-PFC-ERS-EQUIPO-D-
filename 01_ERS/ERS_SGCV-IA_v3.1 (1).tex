...
\end{quote}
\end{minipage} \\
1.1 & 05/08/2026 & Equipo SGCV-IA &
\begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Aplicación de correcciones de la Inspección Fagan (defectos D-01, D-02,
D-03, D-05, D-10, D-18) y de los RFC aprobados por el CCB (RFC-01,
RFC-02: nuevo RF-26, RFC-03: nuevo RNF-16).
\end{quote}
\end{minipage} \\
\end{longtable}
}
...
computadoras de escritorio mediante navegador web, manteniendo una
paridad de funcionalidad esencial de al menos 95\% entre ambos entornos,
conforme a RNF-08.
\end{quote}
\end{minipage} \\
...
directamente por WhatsApp desde la plataforma. Ante la indisponibilidad
del proveedor de mensajería (WhatsApp Business API), el sistema debe
reintentar el envío y notificar al personal administrativo del fallo,
conforme al riesgo identificado para el stakeholder Proveedor del
...
del veterinario, sin que ninguna recomendación pueda aplicarse sin
revisión explícita del veterinario, como apoyo a su juicio clínico.
\end{quote}
\end{minipage} \\
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
...
ficha del paciente. En la primera visita, cuando aún no exista historial
suficiente, el sistema debe notificar la ausencia de datos y omitir la
generación de la recomendación hasta contar con al menos un registro
histórico.
\end{quote}
\end{minipage} \\
\textbf{Dependencias} & \begin{minipage}[t]{\linewidth}\raggedright
...
los cambios al restablecerse la conexión. Los módulos dependientes de IA
(RF-17--RF-19) quedan deshabilitados durante la operación sin conexión y
se reactivan automáticamente al restablecerse la conectividad, sin
afectar el registro y consulta de historiales clínicos.
\end{quote}
\end{minipage} \\
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
...
\subparagraph{RF-26 --- Mecanismo de contingencia ante falla del
proveedor de mensajería}\label{rf-26-mecanismo-de-contingencia-ante-falla-del-proveedor-de-mensajerueda}
...
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Mecanismo de contingencia ante falla del proveedor de mensajería
\end{quote}
\end{minipage} \\
\textbf{Descripción} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe reintentar automáticamente el envío de mensajes vía
WhatsApp/SMS hasta un máximo de 3 intentos, con un intervalo de 5
minutos entre cada uno, y notificar al personal administrativo si el
envío no se logra en un plazo total de 20 minutos.
\end{quote}
\end{minipage} \\
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
RFC-02 --- aprobado con condiciones por el Change Control Board (CCB).
\end{quote}
\end{minipage} \\
\textbf{Prioridad} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
...
\begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema realiza máximo 3 reintentos con intervalo de 5 minutos; si el
envío falla tras el tercer intento, notifica al personal administrativo
antes de que transcurran 20 minutos desde el primer intento.
\end{quote}
\end{minipage} \\
\textbf{Dependencias} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
...
\subparagraph{RNF-01 --- Tiempo de respuesta en búsqueda de
pacientes}\label{rnf-01-tiempo-de-respuesta-en-busqueda-de-pacientes}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Característica ISO/IEC 25010} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
...
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Tiempo de respuesta en búsqueda de pacientes
\end{quote}
\end{minipage} \\
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe responder con rapidez a las búsquedas de pacientes por
nombre del animal o del dueño.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Tiempo de respuesta \(\leq\) 2 segundos en el 95\% de las búsquedas,
sobre una base de hasta 500 pacientes activos.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
RC-03
\end{quote}
\end{minipage} \\
...
\subparagraph{RNF-02 --- Tiempo del proceso de
facturación}\label{rnf-02-tiempo-del-proceso-de-facturacion}
...
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Tiempo del proceso de facturación
\end{quote}
\end{minipage} \\
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El registro de una factura debe completarse de forma ágil, sin pasos
innecesarios.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El proceso de facturación no debe exceder 3 pasos ni 90 segundos desde
el inicio hasta la emisión.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
...
\subparagraph{RNF-03 --- Alertas de vencimiento de
inventario}\label{rnf-03-alertas-de-vencimiento-de-inventario}
...
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Alertas de vencimiento de inventario
\end{quote}
\end{minipage} \\
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe generar alertas de vencimiento de productos de forma
automática y oportuna.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Cobertura del 100\% de los productos registrados; alertas emitidas en
los umbrales de 30, 15 y 7 días antes del vencimiento, con una latencia
máxima de 24 horas.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
...
\subparagraph{RNF-04 --- Disponibilidad offline y
sincronización}\label{rnf-04-disponibilidad-offline-y-sincronizacion}
...
de forma local ante cortes de conectividad, sincronizando al
restablecerse la conexión.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Disponibilidad de funciones críticas \(\geq\) 99\% del tiempo
operativo; sincronización completa en \(\leq\) 30 segundos tras
reconectar.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
...
\subparagraph{RNF-05 --- Control de acceso por perfil de
usuario}\label{rnf-05-control-de-acceso-por-perfil-de-usuario}
...
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe restringir el acceso a la información según el perfil
del usuario.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
100\% de las operaciones sensibles requieren autenticación; al menos 2
perfiles diferenciados; bloqueo de cuenta tras 5 intentos fallidos.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
...
\subparagraph{RNF-06 --- Trazabilidad de cambios en historiales
clínicos}\label{rnf-06-trazabilidad-de-cambios-en-historiales-clinicos}
...
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe registrar todos los cambios realizados sobre los
historiales clínicos.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
100\% de las modificaciones quedan registradas (usuario, fecha y
descripción), sin posibilidad de edición o eliminación retroactiva del
...
\subparagraph{RNF-07 --- Facilidad de aprendizaje del
sistema}\label{rnf-07-facilidad-de-aprendizaje-del-sistema}
...
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe poder ser utilizado por personal con experiencia
digital básica sin un proceso de formación prolongado.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Un usuario ejecuta las tareas principales tras una capacitación
\(\leq\) 2 horas, con una tasa de error \(\leq\) 5\% en sus primeras 10
ejecuciones.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
...
\subparagraph{RNF-08 --- Compatibilidad
multiplataforma}\label{rnf-08-compatibilidad-multiplataforma}
...
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe ser accesible y funcional desde múltiples dispositivos
y plataformas.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Disponibilidad funcional completa en navegadores web actualizados y en
Android 10+ / iOS 14+, con paridad de funciones \(\geq\) 95\% entre
plataformas.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
...
\subparagraph{RNF-09 --- Exactitud y respaldo de las sugerencias de
IA}\label{rnf-09-exactitud-y-respaldo-de-las-sugerencias-de-ia}
...
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Exactitud y respaldo de las sugerencias de IA
\end{quote}
\end{minipage} \\
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Las sugerencias del módulo de IA deben estar respaldadas
científicamente y ser revisables antes de su aplicación.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
100\% de las sugerencias diagnósticas incluyen referencia
bibliográfica y requieren aprobación explícita del veterinario; tiempo
de generación \(\leq\) 5 segundos.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
...
\subparagraph{RNF-10 --- Independencia del módulo de IA
(modularidad)}\label{rnf-10-independencia-del-modulo-de-ia-modularidad}
...
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Independencia del módulo de IA (modularidad)
\end{quote}
\end{minipage} \\
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Una falla del proveedor externo de IA (LLM) no debe afectar la
disponibilidad de los módulos restantes del sistema.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Disponibilidad de los módulos no dependientes de IA \(\geq\) 99\%
incluso ante una caída total del servicio de IA externo.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Sección 2.5 (Dependencias)
\end{quote}
\end{minipage} \\
\end{longtable}
}

\subparagraph{RNF-11 --- Utilización de recursos del
servidor}\label{rnf-11-utilizacion-de-recursos-del-servidor}
...
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe operar dentro de límites razonables de consumo de
recursos del servidor, incluso bajo carga concurrente del personal de
la clínica.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Uso de CPU \(\leq\) 70\% y de memoria \(\leq\) 75\% del backend con
hasta 20 usuarios concurrentes activos.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Equipo de desarrollo (restricción técnica de servidor)
\end{quote}
\end{minipage} \\
\end{longtable}
}

\subparagraph{RNF-12 --- Cifrado de datos
sensibles}\label{rnf-12-cifrado-de-datos-sensibles}
...
\textbf{Característica ISO/IEC 25010} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Seguridad (Confidencialidad / Cifrado de datos)
\end{quote}
\end{minipage} \\
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
...
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
La información sensible del sistema (historiales clínicos, datos de
facturación, credenciales) debe protegerse frente a accesos no
autorizados durante su transmisión y almacenamiento.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
100\% de los datos sensibles cifrados en tránsito (TLS 1.2 o superior)
y en reposo (AES-256); contraseñas almacenadas únicamente mediante
hash con salt.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Comité de ética / protección de datos (LOPDP)
\end{quote}
\end{minipage} \\
\end{longtable}
}

\subparagraph{RNF-13 --- Recuperabilidad ante
fallos}\label{rnf-13-recuperabilidad-ante-fallos}
...
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe permitir recuperar la información ante fallos de
hardware, corrupción de datos o eliminaciones accidentales.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Copias de seguridad automáticas diarias con retención mínima de 30
días; tiempo objetivo de recuperación (RTO) \(\leq\) 4 horas y punto
objetivo de recuperación (RPO) \(\leq\) 24 horas.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Propietario/administrador de la clínica (continuidad del negocio)
\end{quote}
\end{minipage} \\
\end{longtable}
}

\subparagraph{RNF-14 --- Capacidad de prueba del
sistema}\label{rnf-14-capacidad-de-prueba-del-sistema}
...
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Capacidad de prueba del sistema
\end{quote}
\end{minipage} \\
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe facilitar la verificación de su correcto funcionamiento
ante cambios o nuevas versiones.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Cobertura de pruebas automatizadas \(\geq\) 70\% en los módulos
críticos (historial clínico, facturación, IA); despliegue de una nueva
versión en \(\leq\) 30 minutos sin interrupción del servicio.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Equipo de desarrollo (calidad de despliegue)
\end{quote}
\end{minipage} \\
\end{longtable}
}

\subparagraph{RNF-15 --- Satisfacción del usuario
(SUS)}\label{rnf-15-satisfaccion-del-usuario-sus}
...
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe generar una experiencia de uso satisfactoria para el
personal veterinario y administrativo.
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Nivel de satisfacción \(\geq\) 80\% medido mediante encuesta System
Usability Scale (SUS) aplicada tras el primer mes de uso, sobre una
muestra de al menos 5 usuarios activos.
\end{quote}
\end{minipage} \\
\textbf{RC relacionado} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Personal administrativo y Médico veterinario (satisfacción de uso)
\end{quote}
\end{minipage} \\
\end{longtable}
}

\subparagraph{RNF-16 --- Rectificación y eliminación de datos
personales (LOPDP)}\label{rnf-16-rectificacion-y-eliminacion-de-datos-personales-lopdp}
...
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
Rectificación y eliminación de datos personales (LOPDP)
\end{quote}
\end{minipage} \\
\textbf{Descripción (RNF)} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
El sistema debe permitir a los propietarios de mascotas y al personal
solicitar la rectificación o eliminación de sus datos personales,
conforme a la LOPDP (Ecuador). El sistema debe distinguir
explícitamente entre datos administrativos/de contacto (eliminables a
solicitud del titular) e historiales clínicos (sujetos a un período
mínimo de conservación por razones sanitarias, sin eliminación total).
\end{quote}
\end{minipage} \\
\textbf{Métrica / Criterio de aceptación cuantificable} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{quote}
100\% de las solicitudes de rectificación/eliminación de datos
administrativos se procesan en un plazo máximo de 30 días; los
historiales clínicos no son eliminables, solo anonimizables tras el
...
\begin{quote}
Resumen: se documentan 16 requisitos no funcionales (RNF-01 a RNF-16)
clasificados según ISO/IEC 25010. Los RNF-11 a RNF-15 actualizan su
trazabilidad (RC relacionado) conforme al defecto D-01 de la
Inspección Fagan, y el RNF-16 se incorpora conforme a la RFC-03
aprobada con condiciones por el CCB.
\end{quote}
...
\section{\texorpdfstring{\protect\includegraphics[width=5.79722in,height=3.42847in]{./media/image11.png}}{}}\label{section-1}
...
\pandocbounded{\includegraphics[keepaspectratio]{./media/image34.jpeg}}
\end{quote}
...
\includegraphics[width=6.79514in,height=9.61528in]{./media/image39.png}\includegraphics[width=6.79514in,height=9.60833in]{./media/image40.png}\includegraphics[width=6.79514in,height=9.60833in]{./media/image41.png}\includegraphics[width=6.79514in,height=9.60833in]{./media/image42.png}\includegraphics[width=6.79514in,height=9.61528in]{./media/image43.png}\includegraphics[width=6.79514in,height=9.60833in]{./media/image44.png}
